                        ...
                        <div className="d-flex flex-column ms-5">
                            ...
                            <Form onSubmit={ register }>
                                <Form.Group>
                                    ...
                                    <MDBInput className='login-input' wrapperClass='mb-4' id='fullname' type='text' required='required' />
                                    ...
                                    <div className="text-center pt-1 mb-5 pb-1">
                                        <BsButton id='login-btn' variant="secondary" type='submit' size='lg' >Register</BsButton><br />
                                    </div>

                                    <div className="d-flex flex-row align-items-center justify-content-center pb-4 mb-4">
                                        <p className="mb-0">Do you have an account?</p>
                                        <MuiButton id='register-btn' variant="outlined" color="error" as={Link} to="/login">
                                            Login
                                        </MuiButton>
                                    </div>
                                </Form.Group>
